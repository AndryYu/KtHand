...
public final class LogUtils {
    ...
    private static final String DEFAULT_TAG = "LibUtils_TAG";
    // 是否显示日志
    ...
    private static void print2File(final String tag, final String msg) {
        ...
        final String fullPath = (CONFIG.mDir == null ? CONFIG.mDefaultDir : CONFIG.mDir)
                        + CONFIG.mFilePrefix + "-" + format.substring(0, 5) + ".txt";
...
//        long versionCode = BuildConfig.VERSION_CODE;
    ...
    public static class Config {
        ...
        private Config() {
            ...
            Context context = Utils.Companion.getApp().getApplicationContext();
