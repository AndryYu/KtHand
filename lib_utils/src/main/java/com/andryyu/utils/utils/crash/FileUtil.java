...
import com.andryyu.utils.utils.AppUtils;
    ...
    public static void writeLogCrashContent(Context context, final String message) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                FileUtil.writeFile(getFileDir(appName) + "/crash"+TimeStrUtils.dateDay2String(new Date())+".log", TimeStrUtils.getCurTimeString() + " : " + message, true);
            }
        }).start();
    }
