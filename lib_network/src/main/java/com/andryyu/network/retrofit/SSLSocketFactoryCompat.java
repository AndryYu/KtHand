    ...
    static {
        ...
        try {
            ...
            if (socket != null) {
                ...
                SSLSocketFactoryCompat.protocols = (String[]) protocols.toArray(new
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    // take all allowed ciphers that are available and put them into
                    // preferredCiphers
                    ...
                    enabledCiphers.addAll(new HashSet<>(Arrays.asList(socket
                            .getEnabledCipherSuites())));
                    SSLSocketFactoryCompat.cipherSuites = (String[]) enabledCiphers.toArray(new
